...
// ========================================
// Character Auto-Generation Types
// ========================================
...
// Character auto-generation settings
export interface CharacterAutoGenerationSettings {
  id: string;
  userId: string;
  ...
  imagesPerCharacter: number; // Default: 5
  
  // Profile diversity settings
  profileTypes: CharacterProfileType[];
  genderDistribution: {
    male: number;    // Percentage 0-100
    female: number;  // Percentage 0-100
    nonBinary: number; // Percentage 0-100
  };
  
  // Scheduling
  timezone: string;
  generationTimeSlots: string[]; // Times like "09:00", "14:00"
  
  // Character defaults
  makePublicByDefault: boolean;
...
// Auto-generated character record
export interface AutoGeneratedCharacter {
  id: string;
  userId: string;
  settingsId: string;
  characterId: string;
  ...
  // Status
  isApproved: boolean;
  isReleased: boolean; // Published as public
...
// Request to create/update auto-generation settings
export interface CreateAutoGenerationSettingsRequest {
  charactersPerDay?: number;
...
// Character generation queue item
export interface CharacterGenerationQueueItem {
  id: string;
  userId: string;
  settingsId: string;
  profileType: CharacterProfileType;
